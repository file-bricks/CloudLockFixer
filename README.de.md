...
[![Pytest Status](https://img.shields.io/badge/tests-237%20gr%C3%BCn%20%7C%20100%25-brightgreen)](https://github.com/file-bricks/CloudLockFixer)
...
- **Tests:** `pytest`, **237 grün** (Core + P2/P3 + Retry/Resume + i18n + Multicloud inkl.
